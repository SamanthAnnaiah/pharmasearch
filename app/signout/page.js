...
export default function Logout() {
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <h2 className="mb-7 text-2xl font-bold text-center text-gray-700">Logged out Successfully</h2>
            <div className="p-6 bg-white rounded-lg shadow-lg w-80">
                <h2 className="mb-4 text-2xl font-bold text-center text-gray-700">Login Again?</h2>
